...
import com.mhss.app.mybrain.data.receiver.TIMER_COMPLETED_DISMISS_ACTION
import com.mhss.app.mybrain.data.receiver.TIMER_COMPLETED_RESTART_ACTION
import com.mhss.app.mybrain.data.receiver.TIMER_RUNNING_CANCEL_ACTION
import com.mhss.app.mybrain.data.receiver.TIMER_RUNNING_IS_PLAYING
import com.mhss.app.mybrain.data.receiver.TIMER_RUNNING_TIME_TEXT
import com.mhss.app.mybrain.data.receiver.TimerNotificationBroadcastReceiver
import com.mhss.app.mybrain.presentation.main.MainActivity
import com.mhss.app.mybrain.util.timer.GlobalProperties.pendingIntentFlags
import com.mhss.app.mybrain.util.timer.setIntentAction
...
class TimerNotificationHelper @Inject constructor(
    ...
    fun updateTimerServiceNotification(
        ...
        val pauseResumeIcon = if (isPlaying) R.drawable.ic_alarm_red else R.drawable.ic_time
        ...
        val notificationUpdate = getTimerBaseNotification()
            ...
            .addAction(R.drawable.ic_check, "Cancel", cancelIntentAction)
            .build()
    ...
    fun showTimerCompletedNotification() =
        NotificationCompat.Builder(applicationContext, TIMER_COMPLETED_CHANNEL)
            ...
            .addAction(R.drawable.ic_check, "Dismiss", dismissIntentAction)
            .addAction(R.drawable.ic_refresh, "Restart", restartIntentAction)
            .setOngoing(true)
            .build()
    ...
    private fun createTimerNotificationChannels() {
        val timerRunningChannel = NotificationChannelCompat.Builder(
            ...
            .setName(applicationContext.getString(R.string.timer))
            .setDescription(applicationContext.getString(R.string.timer))
            .setSound(null, null)
            .build()
