...
object Constants {
    ...
    // lINKS
    const val PROJECT_GITHUB_LINK = "https://github.com/magush27/DisfunctionApp"
    const val PROJECT_ROADMAP_LINK = "https://github.com/magush27/DisfunctionApp"
    const val PRIVACY_POLICY_LINK = "https://github.com/magush27/DisfunctionApp/blob/disfuncionapp/privacy-policy.md"
    const val GITHUB_ISSUES_LINK = "https://github.com/magush27/DisfunctionApp/issues/disfuncionapp/"
    const val GITHUB_RELEASES_LINK = "https://github.com/magush27/DisfunctionApp/releases"
